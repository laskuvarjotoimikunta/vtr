...
Schemas.Vtr = new SimpleSchema({
      ...
      afFieldInput: {
        ...
        options: function(){
          return [
                  ...
                  {value: 'THM', label: 'Tandemhyppymestari HM'},
                  {value: 'NHM', label: 'Novahyppymestari HM'},
  ...
  discipline: {
    type: String,
    label: "Hyppytyyppi",
    allowedValues: ['CF','Freefly','Freestyle','CP','FS','Kuvaus','Lauta','Liitopuku','Taito','Tarkkuus','Vesi','Yö','Muu'],
    autoform: {
      afFieldInput: {
